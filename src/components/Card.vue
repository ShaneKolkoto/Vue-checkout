    ...
    <div class="card-item__side -front">
      ...
      <div class="card-item__wrapper">
        <div class="card-item__top">
          <img
            src="https://raw.githubusercontent.com/ShaneKolkoto/Vue-checkout/master/src/assets/images/chip.png"
            class="card-item__chip"
          />
          <div class="card-item__type">
            <transition name="slide-fade-up">
              <img
                :src="'https://raw.githubusercontent.com/ShaneKolkoto/Vue-checkout/master/src/assets/images/' + cardType + '.png'"
                v-if="cardType"
                :key="cardType"
                alt
  ...
  computed: {
    ...
    currentCardBackground () {
      if (this.randomBackgrounds && !this.backgroundImage) { // TODO will be optimized
        ...
        return `https://raw.githubusercontent.com/ShaneKolkoto/Vue-checkout/master/src/assets/images/${random}.jpeg`
